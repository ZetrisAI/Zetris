...
namespace Zetris {
    public static class Bot {
        ...
        static int getPreviews() => (SaltyController.Previews > 18)? int.MaxValue : SaltyController.Previews;
        ...
        static void runLogic() {
            ...
            if (GameHelper.boardAddress.Call(playerID) > 0x1000 && GameHelper.OutsideMenu.Call() && GameHelper.getPlayer1Base.Call() > 0x1000) {
                ...
                if (startanim && !startbreak) {
                    ...
                    if (!danger) {
                        MisaMino.FindMove(q, pieces[0], null, 21, misaboard, 0, b2b, 0);
                    }
                }
        ...
        public static void UpdateConfig() {
            ...
            MisaMino.Configure(new MisaMinoParameters(), true, false, false, SaltyController.Intelligence);
        }
